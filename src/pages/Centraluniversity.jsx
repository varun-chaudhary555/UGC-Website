                          ...
                          <table className=' ml-10 border -mt-6! mb-12 border-gray-400'>
                              <thead className='border-b-2!'>
                                  <tr>
                                      ...
                                      <th className='border-r! text-white bg-orange-500 pl-4! py-2'>Type</th>
                                      ...
                                      <th className='px-4! text-white bg-orange-500 pr-10! w-64!'>URL</th>
                                  </tr>
                              </thead>
                              <tbody>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Shogi- Mehli Bypass Road, Shimla</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Chailchowk (Chaichiot), Dist. Mandi</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Barasat - Barrackpore Road, Barberia, Kolkata</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>NH-75, Nagamangala, Mandya</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>ADB Road, Surampalem, Kakinada</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Charholi Budruk, Lohegaon, Pune</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Talwandi Sabo, Bathinda</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Marunji, IT Park, Hinjewadi, Pune</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Chandapura-Anekal Main Road, Bangalore</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Dewas-Ujjain State Highway, Dewas</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Devanahalli, Bengaluru Rural</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Sector-82, Mohali</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Sector-125, Noida</td>
...
<tr className='border-b!'>
  ...
  <td className='border-r! pl-4! pr-4 pt-2'>Private</td>
  <td className='border-r! pl-4! pr-10 pt-2'>Amity University (Gurgaon)</td>
  <td className='border-r! pl-4! pr-10! w-45 pt-2'>Panchgaon, Manesar, Gurgaon</td>
