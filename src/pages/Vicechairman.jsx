  ...
  return (
        <div>
            <div className='relative'>
                ...
                <button className='absolute top-6 left-18 text-orange-500 text-base'>Home / Vice Chairman</button>
                <h1 className='absolute top-14 left-18 text-white'>Vice Chairman</h1>
                <h5 className='absolute top-30 left-18 text-white'>University Grants Commission</h5>
            </div>
            <div className='flex'>
                <div>
                    <h3 className='w-220 mr-2 pl-18 pt-10 text-orange-500! pb-4'>Vice Chairman, UGC</h3>
                    <div className='flex'>
                        {/* <img className='ml-22 h-42' src="https://www.ugc.gov.in/Content/images/CommissionMembers/Vineet_Joshi_Secretary.jpeg" alt="" /> */}
                        <div className='ml-18'>
                            <p className='ml-4  font-bold flex'>Email:- <p className='font-normal'>cm.ugc@nic.in</p> </p>
